...
int dc_dct_pred[];
{
  ...
  for (i=1; ; i++)
  {
    ...
    {
      imp(2,"invalid Huffman code in Decode_MPEG1_Intra_Block()\n");
      Fault_Flag = 1;
      return;
    }
    ...
    if (i>=64)
    {
      imp(3,"DCT coeff index (i) out of bounds (intra)\n");
      Fault_Flag = 1;
      return;
    }
...
int comp;
{
  ...
  for (i=0; ; i++)
  {
    ...
    {
      imp(2,"invalid Huffman code in Decode_MPEG1_Non_Intra_Block()\n");
      Fault_Flag = 1;
      return;
    }
    ...
    if (i>=64)
    {
      imp(3,"DCT coeff index (i) out of bounds (inter)\n");
      Fault_Flag = 1;
      return;
    }
...
int dc_dct_pred[];
{
  ...
  for (i=1; ; i++)
  {
    ...
    {
      imp(2,"invalid Huffman code in Decode_MPEG2_Intra_Block()\n");
      Fault_Flag = 1;
      return;
    }
    ...
    if (tab->run==65) /* escape */
    {
      ...
      if ((val&2047)==0)
      {
        imp(2,"invalid escape in Decode_MPEG2_Intra_Block()\n");
        Fault_Flag = 1;
        return;
      }
      if((sign = (val>=2048)))
    ...
    if (i>=64)
    {
      imp(3,"DCT coeff index (i) out of bounds (intra2)\n");
      Fault_Flag = 1;
      return;
    }
...
int comp;
{
  ...
  for (i=0; ; i++)
  {
    ...
    {
      imp(2,"invalid Huffman code in Decode_MPEG2_Non_Intra_Block()\n");
      Fault_Flag = 1;
      return;
    }
    ...
    if (i>=64)
    {
      imp(3,"DCT coeff index (i) out of bounds (inter2)\n");
      Fault_Flag = 1;
      return;
    }
